...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({UserException.class, MessengerException.class, MessengesException.class, MemorialException.class, SubscriptionException.class, PaymentException.class})
